...
def left_swing_up
	...
	lg1_u = [$j1l,$j2d-20,$j3d-20]
	lg2_u = [$j1l,$j2d+10,$j3d]
	lg3_u = [$j1l,$j2d+10,$j3d]
...
def left_swing_down
	...
	lg3_d = [$j1r,$j2d-20,$j3d-20]
	lg4_d = [$j1l,$j2d,$j3d]
	lg5_d = [$j1r,$j2d,$j3d]

	lg0_u = [$j1l,$j2d-20,$j3d-20]
	lg1_u = [$j1r,$j2d-20,$j3d-20]
	lg2_u = [$j1r,$j2d+10,$j3d]
	lg3_u = [$j1r,$j2d+10,$j3d]
